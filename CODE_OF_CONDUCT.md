...
## 1. Purpose
The **PwnDépôt** project aims to build a robust, scalable, and secure environment for hosting Capture The Flag (CTF) challenges.
...
* Follow established **coding standards and best practices** (linting, semantic commits).
...
* Write **clear commit messages** that describe intent (using Semantic Commits), not just actions.
* Ensure **CI/CD pipelines pass** (Quality & Build checks) before merging code.
...
Refer to the repository’s **[CONTRIBUTING.md](.github/CONTRIBUTING.md)** for technical guidelines and workflow details.
...
* All contributors must follow **responsible disclosure practices** when identifying vulnerabilities within the platform itself.
